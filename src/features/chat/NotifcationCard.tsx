    ...
    <>
      {props.notification !== "" && (
        <div
          ...
          className={`${props.className} relative left-[25%] z-[9999] mt-5 h-[10%] w-full cursor-pointer flex-col content-start justify-start overflow-hidden rounded-md bg-slate-400 p-[1%]`}
        >
