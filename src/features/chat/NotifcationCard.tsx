    ...
    <>
      {props.notification !== "" && (
        <div
          ...
          className={`${props.className} absolute top-5 right-[-25%] z-[9999] h-[10%] w-[24%] cursor-pointer flex-col content-start justify-start overflow-hidden rounded-md bg-slate-400 p-[1%]`}
        >
