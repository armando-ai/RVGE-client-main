...
const NotificationCard = (props: any) => {
  ...
  return (
    <div
      ...
      className={`${props.className} fixed right-4 z-[9999] ${value} mt-5 h-[10%] w-[24%] cursor-pointer  flex-col content-start justify-start overflow-hidden rounded-md bg-slate-400 p-[1%]`}
