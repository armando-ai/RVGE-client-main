    ...
    <>
      {props.notification !== "" && (
        <div
          ...
          className={`${props.className} relative top-5 left-[25%] z-[9999] h-[10%] w-[24%] cursor-pointer flex-col content-start justify-start overflow-hidden rounded-md bg-slate-400 p-[1%]`}
        >
